                        ...
                        <table class="table table-striped table-hover mb-0">
                            ...
                            <tbody>
                                <?php foreach ($cortes as $c) {
                                    echo "<tr id=" . $c->getId() . ">";
                                    echo "<td class='check' id='" . $c->getId() . "'> <span id='check" . $c->getId() . "'  class='far fa-square'></span> " . $c->getId() . "</td>";
                                    echo "<td>" . $c->getModelo()->getNombre() . "</td>";
                                    echo "<td>" . $c->getFecha_Envio() . "</td>";
                                    echo "<td>" . $c->getCantidad() . "</td>";
                                    echo "<td>" . "<a href='modalCorte.php?idCorte=" . $c->getId() . "' data-toggle='modal' data-target='#modalCorte' ><span class='fas fa-eye' data-toggle='tooltip' class='tooltipLink' data-placement='left' data-original-title='Ver Detalles' ></span> </a>
