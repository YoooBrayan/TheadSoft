CREATE DATABASE  IF NOT EXISTS `threadsoft` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `threadsoft`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: threadsoft
-- ------------------------------------------------------
...
--
-- Temporary view structure for view `colorestallasmodelo`
--

DROP TABLE IF EXISTS `colorestallasmodelo`;
/*!50001 DROP VIEW IF EXISTS `colorestallasmodelo`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `colorestallasmodelo` AS SELECT 
 1 AS `modelo`,
 1 AS `talla`,
 1 AS `color_id`,
 1 AS `color`,
...
--
-- Temporary view structure for view `colorestallasmodelod`
--

DROP TABLE IF EXISTS `colorestallasmodelod`;
/*!50001 DROP VIEW IF EXISTS `colorestallasmodelod`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `colorestallasmodelod` AS SELECT 
 1 AS `modelo`,
 1 AS `talla`,
 1 AS `color`,
 1 AS `cantidad`*/;
...
CREATE TABLE `corte` (
  ...
  `corte_satelite` int(11) DEFAULT NULL,
...
--
-- Table structure for table `corte_entregado_bodega`
--

DROP TABLE IF EXISTS `corte_entregado_bodega`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `corte_entregado_bodega` (
  ...
  CONSTRAINT `corte_entregado_bodega_ibfk_1` FOREIGN KEY (`Corte_Estado`) REFERENCES `estado` (`Estado_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `corte_entregado_bodega`
--
...
--
-- Table structure for table `corte_pendiente_bodega`
--

DROP TABLE IF EXISTS `corte_pendiente_bodega`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `corte_pendiente_bodega` (
  ...
  KEY `Corte_Estado` (`Corte_Estado`),
  CONSTRAINT `corte_pendiente_bodega_ibfk_1` FOREIGN KEY (`Corte_ID`) REFERENCES `corte` (`Corte_Id`),
  CONSTRAINT `corte_pendiente_bodega_ibfk_2` FOREIGN KEY (`Corte_Estado`) REFERENCES `estado` (`Estado_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `corte_pendiente_bodega`
--
...
--
-- Table structure for table `corte_talla_color`
--

DROP TABLE IF EXISTS `corte_talla_color`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `corte_talla_color` (
  `corte_talla_color_id` int(11) NOT NULL AUTO_INCREMENT,
  `corte_talla_id` int(11) NOT NULL,
  `color_id` int(11) NOT NULL,
  `cantidad` int(11) NOT NULL,
  PRIMARY KEY (`corte_talla_color_id`),
  KEY `corte_talla_id` (`corte_talla_id`),
  KEY `color_id` (`color_id`),
  CONSTRAINT `corte_talla_color_ibfk_1` FOREIGN KEY (`corte_talla_id`) REFERENCES `corte_talla` (`Corte_Talla_Id`),
  CONSTRAINT `corte_talla_color_ibfk_2` FOREIGN KEY (`color_id`) REFERENCES `color` (`Color_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `corte_talla_color`
--
...
--
-- Temporary view structure for view `cortes`
--

DROP TABLE IF EXISTS `cortes`;
/*!50001 DROP VIEW IF EXISTS `cortes`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `cortes` AS SELECT 
 1 AS `ID`,
 1 AS `Modelo`,
 1 AS `Fecha`,
 1 AS `Cantidad`*/;
...
--
-- Temporary view structure for view `cortesentregadosc`
--

DROP TABLE IF EXISTS `cortesentregadosc`;
/*!50001 DROP VIEW IF EXISTS `cortesentregadosc`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `cortesentregadosc` AS SELECT 
 1 AS `corte_satelite`,
 1 AS `ID`,
 1 AS `Modelo`,
 1 AS `Realizadas`,
...
--
-- Temporary view structure for view `cortesentregadosp`
--

DROP TABLE IF EXISTS `cortesentregadosp`;
/*!50001 DROP VIEW IF EXISTS `cortesentregadosp`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `cortesentregadosp` AS SELECT 
 1 AS `corte_satelite`,
 1 AS `ID`,
 1 AS `Modelo`,
 1 AS `Realizadas`,
...
--
-- Temporary view structure for view `cortesporentregar`
--
...
--
-- Table structure for table `insumo_bodega`
--

DROP TABLE IF EXISTS `insumo_bodega`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `insumo_bodega` (
  ...
  `Insumo_Bodega` int(11) NOT NULL,
  PRIMARY KEY (`Insumo_Id`),
  KEY `Insumo_Bodega` (`Insumo_Bodega`),
  CONSTRAINT `insumo_bodega_ibfk_1` FOREIGN KEY (`Insumo_Bodega`) REFERENCES `corte_entregado_bodega` (`Corte_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `insumo_bodega`
--
...
--
-- Table structure for table `modelo_almacen`
--

DROP TABLE IF EXISTS `modelo_almacen`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `modelo_almacen` (
  `modelo_almacen_id` int(11) NOT NULL AUTO_INCREMENT,
  `modelo_distribuido_id` int(11) NOT NULL,
  `almacen_id` int(11) NOT NULL,
  PRIMARY KEY (`modelo_almacen_id`),
  KEY `modelo_distribuido_id` (`modelo_distribuido_id`),
  KEY `almacen_id` (`almacen_id`),
  CONSTRAINT `modelo_almacen_ibfk_1` FOREIGN KEY (`modelo_distribuido_id`) REFERENCES `modelo_distribuido` (`modelo_distribuido_id`),
  CONSTRAINT `modelo_almacen_ibfk_2` FOREIGN KEY (`almacen_id`) REFERENCES `almacen` (`almacen_id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `modelo_almacen`
--
...
--
-- Table structure for table `modelo_distribuido`
--

DROP TABLE IF EXISTS `modelo_distribuido`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `modelo_distribuido` (
  `modelo_distribuido_id` int(11) NOT NULL AUTO_INCREMENT,
  `modelo_id` int(11) NOT NULL,
  PRIMARY KEY (`modelo_distribuido_id`),
  KEY `modelo_id` (`modelo_id`),
  CONSTRAINT `modelo_distribuido_ibfk_1` FOREIGN KEY (`modelo_id`) REFERENCES `modelo` (`Modelo_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `modelo_distribuido`
--
...
--
-- Table structure for table `modelo_distribuido_talla`
--

DROP TABLE IF EXISTS `modelo_distribuido_talla`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `modelo_distribuido_talla` (
  ...
  KEY `modelo_distribuido_id` (`modelo_distribuido_id`),
  KEY `talla_id` (`talla_id`),
  CONSTRAINT `modelo_distribuido_talla_ibfk_1` FOREIGN KEY (`modelo_distribuido_id`) REFERENCES `modelo_distribuido` (`modelo_distribuido_id`),
  CONSTRAINT `modelo_distribuido_talla_ibfk_2` FOREIGN KEY (`talla_id`) REFERENCES `talla` (`Talla_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `modelo_distribuido_talla`
--
...
--
-- Table structure for table `modelo_talla_color`
--

DROP TABLE IF EXISTS `modelo_talla_color`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `modelo_talla_color` (
  ...
  KEY `MDT_id` (`MDT_id`),
  KEY `color_id` (`color_id`),
  CONSTRAINT `modelo_talla_color_ibfk_1` FOREIGN KEY (`MDT_id`) REFERENCES `modelo_distribuido_talla` (`modelo_D_talla_id`),
  CONSTRAINT `modelo_talla_color_ibfk_2` FOREIGN KEY (`color_id`) REFERENCES `color` (`Color_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `modelo_talla_color`
--
...
--
-- Table structure for table `modelo_vendido`
--

DROP TABLE IF EXISTS `modelo_vendido`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `modelo_vendido` (
  `modelo_vendido_id` int(11) NOT NULL AUTO_INCREMENT,
  `modelo_almacen_id` int(11) NOT NULL,
  `venta_id` int(11) NOT NULL,
  PRIMARY KEY (`modelo_vendido_id`),
  KEY `modelo_almacen_id` (`modelo_almacen_id`),
  KEY `venta_id` (`venta_id`),
  CONSTRAINT `modelo_vendido_ibfk_1` FOREIGN KEY (`modelo_almacen_id`) REFERENCES `modelo_almacen` (`modelo_almacen_id`),
  CONSTRAINT `modelo_vendido_ibfk_2` FOREIGN KEY (`venta_id`) REFERENCES `venta` (`venta_id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `modelo_vendido`
--
...
--
-- Table structure for table `modelo_venta_talla`
--

DROP TABLE IF EXISTS `modelo_venta_talla`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `modelo_venta_talla` (
  `modelo_venta_talla_id` int(11) NOT NULL AUTO_INCREMENT,
  `modelo_vendido_id` int(11) NOT NULL,
  `talla_id` varchar(4) NOT NULL,
  PRIMARY KEY (`modelo_venta_talla_id`),
  KEY `modelo_vendido_id` (`modelo_vendido_id`),
  KEY `talla_id` (`talla_id`),
  CONSTRAINT `modelo_venta_talla_ibfk_1` FOREIGN KEY (`modelo_vendido_id`) REFERENCES `modelo_vendido` (`modelo_vendido_id`),
  CONSTRAINT `modelo_venta_talla_ibfk_2` FOREIGN KEY (`talla_id`) REFERENCES `talla` (`Talla_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `modelo_venta_talla`
--
...
CREATE TABLE `operario` (
  ...
  `Operario_Satelite` int(11) NOT NULL,
  PRIMARY KEY (`Operario_Id`),
  KEY `Operario_Usuario` (`Operario_Usuario`),
  KEY `Operario_Satelite` (`Operario_Satelite`),
  CONSTRAINT `operario_ibfk_1` FOREIGN KEY (`Operario_Usuario`) REFERENCES `usuario` (`Usuario_Id`),
  CONSTRAINT `operario_ibfk_2` FOREIGN KEY (`Operario_Satelite`) REFERENCES `satelite` (`satelite_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary view structure for view `operarios`
--
...
CREATE TABLE `satelite` (
  `satelite_Id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Temporary view structure for view `tallasmodelo`
--

DROP TABLE IF EXISTS `tallasmodelo`;
/*!50001 DROP VIEW IF EXISTS `tallasmodelo`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `tallasmodelo` AS SELECT 
 1 AS `modelo`,
 1 AS `talla`,
 1 AS `cantidad`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `tallasmodelod`
--

DROP TABLE IF EXISTS `tallasmodelod`;
/*!50001 DROP VIEW IF EXISTS `tallasmodelod`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `tallasmodelod` AS SELECT 
 1 AS `modelo`,
 1 AS `talla`,
 1 AS `cantidad`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `tallasmodelosalmacen`
--

DROP TABLE IF EXISTS `tallasmodelosalmacen`;
/*!50001 DROP VIEW IF EXISTS `tallasmodelosalmacen`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `tallasmodelosalmacen` AS SELECT 
 1 AS `almacen`,
 1 AS `modelo`,
 1 AS `talla_id`,
 1 AS `cantidadAlmacen`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `tallasmodelosvendidos`
--

DROP TABLE IF EXISTS `tallasmodelosvendidos`;
/*!50001 DROP VIEW IF EXISTS `tallasmodelosvendidos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `tallasmodelosvendidos` AS SELECT 
 1 AS `almacen`,
 1 AS `modelo`,
 1 AS `talla_id`,
 1 AS `cantidadVenta`*/;
...
--
-- Table structure for table `telefono_admi`
--

DROP TABLE IF EXISTS `telefono_admi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `telefono_admi` (
  `Telefono_Numero` int(11) NOT NULL,
  `Telefono_Operador` varchar(20) DEFAULT NULL,
  `Telefono_Administrador_Id` int(11) NOT NULL,
  PRIMARY KEY (`Telefono_Numero`),
  KEY `Telefono_Administrador_Id` (`Telefono_Administrador_Id`),
  CONSTRAINT `telefono_admi_ibfk_1` FOREIGN KEY (`Telefono_Administrador_Id`) REFERENCES `administrador` (`Administrador_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `telefono_admi`
--
...
--
-- Table structure for table `telefono_operario`
--

DROP TABLE IF EXISTS `telefono_operario`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `telefono_operario` (
  `Telefono_Numero` int(11) NOT NULL,
  `Telefono_Operador` varchar(20) DEFAULT NULL,
  `Telefono_Operario_Id` int(11) NOT NULL,
  PRIMARY KEY (`Telefono_Numero`),
  KEY `Telefono_Operario_Id` (`Telefono_Operario_Id`),
  CONSTRAINT `telefono_operario_ibfk_1` FOREIGN KEY (`Telefono_Operario_Id`) REFERENCES `operario` (`Operario_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `telefono_operario`
--
...
CREATE TABLE `telefono_proveedor` (
  `Telefono_Numero` int(11) NOT NULL,
  `Telefono_Operador` varchar(20) DEFAULT NULL,
  `Telefono_Proveedor_Id` int(11) NOT NULL,
  PRIMARY KEY (`Telefono_Numero`),
  KEY `Telefono_Proveedor_Id` (`Telefono_Proveedor_Id`),
  CONSTRAINT `telefono_proveedor_ibfk_1` FOREIGN KEY (`Telefono_Proveedor_Id`) REFERENCES `proveedor` (`Proveedor_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `venta_talla_color`
--

DROP TABLE IF EXISTS `venta_talla_color`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `venta_talla_color` (
  `venta_talla_color_id` int(11) NOT NULL AUTO_INCREMENT,
  `modelo_venta_Talla_id` int(11) NOT NULL,
  `color_id` int(11) NOT NULL,
  `cantidad` int(11) NOT NULL,
  PRIMARY KEY (`venta_talla_color_id`),
  KEY `modelo_venta_Talla_id` (`modelo_venta_Talla_id`),
  KEY `color_id` (`color_id`),
  CONSTRAINT `venta_talla_color_ibfk_1` FOREIGN KEY (`modelo_venta_Talla_id`) REFERENCES `modelo_venta_talla` (`modelo_venta_talla_id`),
  CONSTRAINT `venta_talla_color_ibfk_2` FOREIGN KEY (`color_id`) REFERENCES `color` (`Color_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `venta_talla_color`
--
...
--
-- Dumping events for database 'threadsoft'
--

--
-- Dumping routines for database 'threadsoft'
--
...
--
-- Final view structure for view `colorestallasmodelo`
--
...
/*!50001 VIEW `colorestallasmodelo` AS select `c`.`Corte_Modelo` AS `modelo`,`ct`.`Talla_Id` AS `talla`,`co`.`Color_Id` AS `color_id`,`co`.`Color_Nombre` AS `color`,sum(`ctc`.`cantidad`) AS `cantidad` from (((`corte` `c` join `corte_talla` `ct` on((`c`.`Corte_Id` = `ct`.`Corte_Id`))) join `corte_talla_color` `ctc` on((`ct`.`Corte_Talla_Id` = `ctc`.`corte_talla_id`))) join `color` `co` on((`co`.`Color_Id` = `ctc`.`color_id`))) group by `ctc`.`color_id`,`ct`.`Talla_Id` order by `ct`.`Talla_Id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `colorestallasmodelod`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `colorestallasmodelod` AS select `m`.`Modelo_Id` AS `modelo`,`mdt`.`talla_id` AS `talla`,`c`.`Color_Nombre` AS `color`,sum(`mtc`.`cantidad`) AS `cantidad` from (((((`modelo_almacen` `ma` join `modelo_distribuido` `md` on((`ma`.`modelo_distribuido_id` = `md`.`modelo_distribuido_id`))) join `modelo_distribuido_talla` `mdt` on((`md`.`modelo_distribuido_id` = `mdt`.`modelo_distribuido_id`))) join `modelo` `m` on((`m`.`Modelo_Id` = `md`.`modelo_id`))) join `modelo_talla_color` `mtc` on((`mtc`.`MDT_id` = `mdt`.`modelo_D_talla_id`))) join `color` `c` on((`c`.`Color_Id` = `mtc`.`color_id`))) group by `mtc`.`color_id`,`mdt`.`talla_id` order by `mdt`.`talla_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `cortes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `cortesentregadosc` AS select `corte`.`corte_satelite` AS `corte_satelite`,`corte`.`Corte_Id` AS `ID`,`modelo`.`Modelo_Nombre` AS `Modelo`,sum(`corte_talla`.`Cantidad`) AS `Realizadas`,`corte_entregado_bodega`.`Corte_Fecha_Entrega` AS `Fecha de Entrega`,`corte_entregado_bodega`.`Corte_Estado` AS `corte_estado`,sum((`corte_talla`.`Cantidad` * `modelo`.`Modelo_Valor`)) AS `Total Pago` from (((`corte` join `corte_talla`) join `corte_entregado_bodega`) join `modelo`) where ((`corte`.`Corte_Id` = `corte_talla`.`Corte_Id`) and (`corte`.`Corte_Id` = `corte_entregado_bodega`.`Corte_ID`) and (`corte`.`Corte_Modelo` = `modelo`.`Modelo_Id`) and (`corte_entregado_bodega`.`Corte_Estado` <> 2) and (`corte_entregado_bodega`.`Corte_Estado` <> 4)) group by `corte`.`Corte_Id` order by `corte_entregado_bodega`.`Corte_Estado` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `cortesentregadosp`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `cortesentregadosp` AS select `corte`.`corte_satelite` AS `corte_satelite`,`corte_pendiente_bodega`.`Corte_ID` AS `ID`,`modelo`.`Modelo_Nombre` AS `Modelo`,sum(`corte_pendiente_bodega`.`Corte_Cantidad_Entregada`) AS `Realizadas`,`corte_pendiente_bodega`.`Corte_Fecha_Entrega` AS `Fecha de Entrega`,`corte_pendiente_bodega`.`Corte_Estado` AS `corte_estado`,sum((`corte_pendiente_bodega`.`Corte_Cantidad_Entregada` * `modelo`.`Modelo_Valor`)) AS `Pago` from (((`corte_pendiente_bodega` join `modelo`) join `corte_talla`) join `corte`) where ((not(`corte_pendiente_bodega`.`Corte_ID` in (select `corte_entregado_bodega`.`Corte_ID` from `corte_entregado_bodega`))) and (`corte`.`Corte_Id` = `corte_pendiente_bodega`.`Corte_ID`) and (`corte`.`Corte_Modelo` = `modelo`.`Modelo_Id`) and (`corte`.`Corte_Id` = `corte_talla`.`Corte_Id`) and (`corte_pendiente_bodega`.`Corte_Estado` <> 3) and (`corte_pendiente_bodega`.`Corte_Estado` <> 1)) group by `corte_pendiente_bodega`.`Corte_ID` order by `corte_pendiente_bodega`.`Corte_Estado` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `operarios` AS select `operario`.`Operario_Id` AS `ID`,`operario`.`Operario_Nombre` AS `Nombre`,`operario`.`Operario_Correo` AS `Correo`,`operario`.`Operario_Satelite` AS `Operario_Satelite` from `operario` order by `operario`.`Operario_Id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `tallasmodelo`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `tallasmodelo` AS select `c`.`Corte_Modelo` AS `modelo`,`ct`.`Talla_Id` AS `talla`,sum(`ct`.`Cantidad`) AS `cantidad` from (`corte` `c` join `corte_talla` `ct` on((`c`.`Corte_Id` = `ct`.`Corte_Id`))) group by `ct`.`Talla_Id`,`c`.`Corte_Id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `tallasmodelod`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `tallasmodelod` AS select `m`.`Modelo_Id` AS `modelo`,`mdt`.`talla_id` AS `talla`,sum(`mdt`.`cantidad`) AS `cantidad` from (((`modelo_almacen` `ma` join `modelo_distribuido` `md` on((`ma`.`modelo_distribuido_id` = `md`.`modelo_distribuido_id`))) join `modelo_distribuido_talla` `mdt` on((`md`.`modelo_distribuido_id` = `mdt`.`modelo_distribuido_id`))) join `modelo` `m` on((`m`.`Modelo_Id` = `md`.`modelo_id`))) group by `mdt`.`talla_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `tallasmodelosalmacen`
--
...
-- Dump completed on 2020-09-19 20:21:39
